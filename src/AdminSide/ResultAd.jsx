...
const teams = ['Select Team','Kondotty','Pulikkal','Malappuram','Manjeri West', 'Manjeri East', 'Perinthalmanna', 'Kolathur','Wandoor','Areekode','Nilambur','Edakkara']
  ...
  return (
    <div className="border border-theme_black w-full  pb-10 pt-6 padding-x">
      ...
      <form className="grid grid-cols-2 max-md:grid-cols-1 gap-6 font-poppins">
        <select
          name="category"
          className="w-full border border-theme_black p-3"
          id=""
        >
        ...
        <input type="text" className='w-full border border-theme_black p-3 placeholder:text-black' placeholder='Enter Name' />
        <select
          name="item"
          className="w-full border border-theme_black p-3"
          id=""
        ...
        <label htmlFor='poster-upload' className='border border-theme_black w-full p-3 text-center font-medium bg-theme_yellow'>Upload Poster Template</label>
        <input className='hidden' id='poster-upload' type="file" placeholder='Upload Poster Template' />
        <button className='border border-theme_black bg-theme_red p-3 text-white font-medium' type='submit'>Upload</button>
