...
const handleToggle = ()=>{
  ...
  return (
    <section className="mt-48 z-150 fixed flex gap-1">
      ...
      <div onClick={handleToggle} className="h-16 w-10 bg-theme_yellow rounded-r-full flex justify-center items-center cursor-pointer hover:bg-theme_gold">
        <GiTrophyCup />
      </div>

      {scoreOn && <div className="w-72 flex">
