...
const Score = ({scoreOn, setScoreOn}) => {
  ...
  const winners = [
    {team: 'Kondotty', Point: 0},
    {team: 'Areekode', Point: 0},
    {team: 'Pulikkal', Point: 0},
  ];
  const teamPoints = [
    {team: 'Edakkara', Point: 0},
    {team: 'Nilambur', Point: 0},
    {team: 'Kolathur', Point: 0},
    {team: 'Manjeri East', Point: 0},
    {team: 'Manjeri West', Point: 0},
    {team: 'Perinthalmanna', Point: 0},
    {team: 'Malappuram', Point: 0},
    {team: 'Wandoor', Point: 0},
  ];
      ...
      {scoreOn &&
        ...
        >
          ...
          <div className="p-8 w-72 ml-2 bg-aquamarine font-ppneue rounded-3xl flex flex-col">
            ...
            <ul className="text-lg font-grotesk">
              {teamPoints.map (team => (
                <li className="flex items-center gap-3">
                  {team.team}
                  {' '}
                  <span className=" text-xl">
                    {team.Point > 0
                      ? <AnimatedCounter endValue={0} duration={1000} />
                      : 0}
                  </span>
                </li>
              ))}
