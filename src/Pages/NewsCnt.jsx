    ...
    <section className="mt-16 max-container padding-y padding-x ">
      <div className="mb-8 flex max-md:flex-col max-md:items-start justify-between items-end ">
        ...
        <div className="mb-5 max-md:hidden">
          ...
          <a href="https://whatsapp.com/channel/0029Vahbl5FKWEKmOoxvzj0D"><h2 className="text-gray-400 flex items-center cursor-pointer gap-2 leading-4 font-semibold">
            For more
            <br />
            {' '}
            updates
      ...
      <h1 className=" mb-8 w-2/3 text-left font-baloo leading-9 font-bold text-3xl text-aquamarine">
        മുപ്പത്തിയൊന്നാമത് മലപ്പുറം ഈസ്റ്റ് ജില്ലാ സാഹിത്യോത്സവിനു എടവണ്ണപ്പാറയിൽ നാളെ തുടക്കമാകും.
      </h1>

      <div className="text-white font-baloo font-xl font-medium">
